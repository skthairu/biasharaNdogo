...
import { ArrowRight, CheckCircle2, ChevronLeft, ChevronRight, CircleAlert, CreditCard, LockKeyhole, MessageCircle, ShieldCheck, UserRound, Building2 } from "lucide-react";
...
const emptyForm = {
  ...
  businessRegistrationNumber: "", kraPin: "",
};

type FormState = typeof emptyForm;
type ExtraKycPayload = { monthlyTransactionBracket: string; mpesaNumber: string };
...
export default function Membership() {
  ...
  const submit = () => {
    ...
    const payload = { ...form } as FormState & ExtraKycPayload;
